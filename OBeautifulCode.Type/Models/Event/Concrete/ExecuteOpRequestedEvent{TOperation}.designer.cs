...
namespace OBeautifulCode.Type
{
    ...
    public partial class ExecuteOpRequestedEvent<TOperation> : IModel<ExecuteOpRequestedEvent<TOperation>>
    {
        ...
        {
            var result = Invariant($"OBeautifulCode.Type.{this.GetType().ToStringReadable()}: TimestampUtc = {this.TimestampUtc.ToString(CultureInfo.InvariantCulture) ?? "<null>"}, Operation = {this.Operation?.ToString() ?? "<null>"}, Details = {this.Details?.ToString(CultureInfo.InvariantCulture) ?? "<null>"}.");
