...
namespace OBeautifulCode.Type
{
    ...
    [Serializable]
    public partial class UtcDateTimeRangeInclusive : IModel<UtcDateTimeRangeInclusive>
    {
        /// <summary>
        ...
        public static bool operator ==(UtcDateTimeRangeInclusive left, UtcDateTimeRangeInclusive right)
        {
        ...
        public static bool operator !=(UtcDateTimeRangeInclusive left, UtcDateTimeRangeInclusive right) => !(left == right);

        /// <inheritdoc />
        public bool Equals(UtcDateTimeRangeInclusive other)
        {
            ...
            var result = this.StartDateTimeInUtc.IsEqualTo(other.StartDateTimeInUtc)
                      && this.EndDateTimeInUtc.IsEqualTo(other.EndDateTimeInUtc);
        ...
        public override int GetHashCode() => HashCodeHelper.Initialize()
            .Hash(this.StartDateTimeInUtc)
            .Hash(this.EndDateTimeInUtc)
            .Value;
        ...
        public UtcDateTimeRangeInclusive DeepClone()
        {
            var result = new UtcDateTimeRangeInclusive(
                                 this.StartDateTimeInUtc.DeepClone(),
                                 this.EndDateTimeInUtc.DeepClone());

            return result;
        }

        /// <summary>
        /// Deep clones this object with a new <see cref="StartDateTimeInUtc" />.
        /// </summary>
        /// <param name="startDateTimeInUtc">The new <see cref="StartDateTimeInUtc" />.  This object will NOT be deep cloned; it is used as-is.</param>
        /// <returns>New <see cref="UtcDateTimeRangeInclusive" /> using the specified <paramref name="startDateTimeInUtc" /> for <see cref="StartDateTimeInUtc" /> and a deep clone of every other property.</returns>
        ...
        public UtcDateTimeRangeInclusive DeepCloneWithStartDateTimeInUtc(DateTime startDateTimeInUtc)
        {
            var result = new UtcDateTimeRangeInclusive(
                                 startDateTimeInUtc,
                                 this.EndDateTimeInUtc.DeepClone());
        ...
        /// <summary>
        /// Deep clones this object with a new <see cref="EndDateTimeInUtc" />.
        /// </summary>
        /// <param name="endDateTimeInUtc">The new <see cref="EndDateTimeInUtc" />.  This object will NOT be deep cloned; it is used as-is.</param>
        /// <returns>New <see cref="UtcDateTimeRangeInclusive" /> using the specified <paramref name="endDateTimeInUtc" /> for <see cref="EndDateTimeInUtc" /> and a deep clone of every other property.</returns>
        [SuppressMessage("Microsoft.Design", "CA1002:DoNotExposeGenericLists")]
        [SuppressMessage("Microsoft.Maintainability", "CA1502:AvoidExcessiveComplexity")]
        [SuppressMessage("Microsoft.Design", "CA1054:UriParametersShouldNotBeStrings")]
        [SuppressMessage("Microsoft.Naming", "CA1702:CompoundWordsShouldBeCasedCorrectly")]
        ...
        [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
        [SuppressMessage("Microsoft.Performance", "CA1822:MarkMembersAsStatic")]
        public UtcDateTimeRangeInclusive DeepCloneWithEndDateTimeInUtc(DateTime endDateTimeInUtc)
        {
            var result = new UtcDateTimeRangeInclusive(
                                 this.StartDateTimeInUtc.DeepClone(),
                                 endDateTimeInUtc);
            ...
            PropertyPathTracker propertyPathTracker = null)
        {
            ...
            void ValidateProperties()
            {
                ...
                localValidationFailures = ValidatableExtensions.GetValidationFailures(this.StartDateTimeInUtc, options, propertyPathTracker, nameof(this.StartDateTimeInUtc));
                ...
                localValidationFailures = ValidatableExtensions.GetValidationFailures(this.EndDateTimeInUtc, options, propertyPathTracker, nameof(this.EndDateTimeInUtc));
                result.AddRange(localValidationFailures);
                if (stopOnFirstObjectWithFailures && result.Any())
                {
                    return;
