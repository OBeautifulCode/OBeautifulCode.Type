...
namespace OBeautifulCode.Type.Test
{
    ...
    {
        private static readonly StringRepresentationTestScenarios<ValidationFailure> StringRepresentationTestScenarios = new StringRepresentationTestScenarios<ValidationFailure>();

        private static readonly ConstructorArgumentValidationTestScenarios<ValidationFailure> ConstructorArgumentValidationTestScenarios = new ConstructorArgumentValidationTestScenarios<ValidationFailure>()
            .AddScenario(() =>
                new ConstructorArgumentValidationTestScenario<ValidationFailure>
                {
                    Name = "constructor should throw ArgumentNullException when parameter 'originType' is null scenario",
                    ConstructionFunc = () =>
                    {
                        var referenceObject = A.Dummy<ValidationFailure>();

                        var result = new ValidationFailure(
                                             null,
                                             referenceObject.Path,
                                             referenceObject.Message);

                        return result;
                    },
                    ExpectedExceptionType = typeof(ArgumentNullException),
                    ExpectedExceptionMessageContains = new[] { "originType", },
                })
            .AddScenario(() =>
                new ConstructorArgumentValidationTestScenario<ValidationFailure>
                {
                    Name = "constructor should throw ArgumentException when parameter 'originType' is white space scenario",
                    ConstructionFunc = () =>
                    {
                        var referenceObject = A.Dummy<ValidationFailure>();
                    ...
                    ExpectedExceptionMessageContains = new[] { "originType", "white space", },
                })
            .AddScenario(() =>
                new ConstructorArgumentValidationTestScenario<ValidationFailure>
                {
                    Name = "constructor should throw ArgumentNullException when parameter 'path' is null scenario",
                    ConstructionFunc = () =>
                    {
                        var referenceObject = A.Dummy<ValidationFailure>();

                        var result = new ValidationFailure(
                                             referenceObject.OriginType,
                                             null,
                                             referenceObject.Message);
                    ...
                    ExpectedExceptionType = typeof(ArgumentNullException),
                    ExpectedExceptionMessageContains = new[] { "path", },
                })
            .AddScenario(() =>
                new ConstructorArgumentValidationTestScenario<ValidationFailure>
                {
                    Name = "constructor should throw ArgumentException when parameter 'path' is white space scenario",
                    ConstructionFunc = () =>
                    {
                        var referenceObject = A.Dummy<ValidationFailure>();
                    ...
                    ExpectedExceptionType = typeof(ArgumentException),
                    ExpectedExceptionMessageContains = new[] { "path", "white space", },
                })
            .AddScenario(() =>
                new ConstructorArgumentValidationTestScenario<ValidationFailure>
                {
        ...
        private static readonly ConstructorPropertyAssignmentTestScenarios<ValidationFailure> ConstructorPropertyAssignmentTestScenarios = new ConstructorPropertyAssignmentTestScenarios<ValidationFailure>()
            .AddScenario(() =>
                new ConstructorPropertyAssignmentTestScenario<ValidationFailure>
                {
                    Name = "OriginType should return same 'originType' parameter passed to constructor when getting",
                    SystemUnderTestExpectedPropertyValueFunc = () =>
                    {
                        var referenceObject = A.Dummy<ValidationFailure>();

                        var result = new SystemUnderTestExpectedPropertyValue<ValidationFailure>
                        {
                            SystemUnderTest = new ValidationFailure(
                                                      referenceObject.OriginType,
                                                      referenceObject.Path,
                                                      referenceObject.Message),
                            ExpectedPropertyValue = referenceObject.OriginType,
                        };

                        return result;
                    },
                    PropertyName = "OriginType",
                })
            .AddScenario(() =>
                new ConstructorPropertyAssignmentTestScenario<ValidationFailure>
                {
                    Name = "Path should return same 'path' parameter passed to constructor when getting",
                    SystemUnderTestExpectedPropertyValueFunc = () =>
                    {
                        var referenceObject = A.Dummy<ValidationFailure>();
                        ...
                        var result = new SystemUnderTestExpectedPropertyValue<ValidationFailure>
                        {
                            SystemUnderTest = new ValidationFailure(
                                                      ...
                                                      referenceObject.Path,
                                                      referenceObject.Message),
                            ExpectedPropertyValue = referenceObject.Path,
                        };
        ...
        private static readonly DeepCloneWithTestScenarios<ValidationFailure> DeepCloneWithTestScenarios = new DeepCloneWithTestScenarios<ValidationFailure>()
            .AddScenario(() =>
                new DeepCloneWithTestScenario<ValidationFailure>
                {
                    Name = "DeepCloneWithOriginType should deep clone object and replace OriginType with the provided originType",
                    WithPropertyName = "OriginType",
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        var systemUnderTest = A.Dummy<ValidationFailure>();

                        var referenceObject = A.Dummy<ValidationFailure>().ThatIs(_ => !systemUnderTest.OriginType.IsEqualTo(_.OriginType));

                        var result = new SystemUnderTestDeepCloneWithValue<ValidationFailure>
                        {
                            SystemUnderTest = systemUnderTest,
                            DeepCloneWithValue = referenceObject.OriginType,
                        };
            ...
            .AddScenario(() =>
                new DeepCloneWithTestScenario<ValidationFailure>
                {
                    Name = "DeepCloneWithPath should deep clone object and replace Path with the provided path",
                    WithPropertyName = "Path",
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        var systemUnderTest = A.Dummy<ValidationFailure>();

                        var referenceObject = A.Dummy<ValidationFailure>().ThatIs(_ => !systemUnderTest.Path.IsEqualTo(_.Path));

                        var result = new SystemUnderTestDeepCloneWithValue<ValidationFailure>
                        {
                            SystemUnderTest = systemUnderTest,
                            DeepCloneWithValue = referenceObject.Path,
                        };
            ...
            .AddScenario(() =>
                new DeepCloneWithTestScenario<ValidationFailure>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<ValidationFailure>().ThatIs(_ => !systemUnderTest.Message.IsEqualTo(_.Message));
        ...
        private static readonly ValidationFailure ReferenceObjectForEquatableTestScenarios = A.Dummy<ValidationFailure>();

        private static readonly EquatableTestScenarios<ValidationFailure> EquatableTestScenarios = new EquatableTestScenarios<ValidationFailure>()
            .AddScenario(() =>
                new EquatableTestScenario<ValidationFailure>
                {
                    Name = "Default Code Generated Scenario",
                    ReferenceObject = ReferenceObjectForEquatableTestScenarios,
                    ObjectsThatAreEqualToButNotTheSameAsReferenceObject = new ValidationFailure[]
                    {
                        new ValidationFailure(
                                ReferenceObjectForEquatableTestScenarios.OriginType,
                                ReferenceObjectForEquatableTestScenarios.Path,
                                ReferenceObjectForEquatableTestScenarios.Message),
                    },
                    ObjectsThatAreNotEqualToReferenceObject = new ValidationFailure[]
                    {
                        new ValidationFailure(
                                A.Dummy<ValidationFailure>().Whose(_ => !_.OriginType.IsEqualTo(ReferenceObjectForEquatableTestScenarios.OriginType)).OriginType,
                                ReferenceObjectForEquatableTestScenarios.Path,
                                ReferenceObjectForEquatableTestScenarios.Message),
                        new ValidationFailure(
                                ReferenceObjectForEquatableTestScenarios.OriginType,
                                A.Dummy<ValidationFailure>().Whose(_ => !_.Path.IsEqualTo(ReferenceObjectForEquatableTestScenarios.Path)).Path,
                                ReferenceObjectForEquatableTestScenarios.Message),
                        new ValidationFailure(
                                ReferenceObjectForEquatableTestScenarios.OriginType,
                                ReferenceObjectForEquatableTestScenarios.Path,
                                A.Dummy<ValidationFailure>().Whose(_ => !_.Message.IsEqualTo(ReferenceObjectForEquatableTestScenarios.Message)).Message),
                    },
        ...
        public static class Structural
        {
            ...
            public static void ValidationFailure___Should_declare_ToString_method___When_reflecting()
            {
                // Arrange
                var expected = typeof(ValidationFailure);
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void ValidationFailure___Should_be_attributed_with_Serializable____When_reflecting()
            {
                // Arrange
        ...
        public static class Cloning
        {
            ...
            public static void Clone___Should_clone_object___When_called()
            {
                ...
                // Act
                var actual = (ValidationFailure)systemUnderTest.Clone();
            ...
            {
                var propertyNames = new string[] { "OriginType", "Path", "Message" };
                ...
                foreach (var scenario in scenarios)
                {
                    ...
                    // Act
                    var actual = (ValidationFailure)scenario.DeepCloneWithMethod.Invoke(scenario.SystemUnderTest, new[] { scenario.WithValue });

                    // Assert
                    foreach (var propertyName in propertyNames)
                    {
                        var propertyInfo = typeof(ValidationFailure).GetPropertyFiltered(propertyName, MemberRelationships.DeclaredOrInherited, MemberOwners.Instance, MemberAccessModifiers.Public);
        ...
        public static class Equality
        {
            ...
            {
                // Arrange
                ValidationFailure systemUnderTest1 = null;
                ValidationFailure systemUnderTest2 = null;
            ...
            public static void EqualsOperator___Should_return_false___When_one_side_of_operator_is_null_and_the_other_side_is_not_null()
            {
                ...
                {
                    // Arrange
                    ValidationFailure systemUnderTest = null;
...
#pragma warning restore CS1718 // Comparison made to same variable
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_ValidationFailure___Should_return_false___When_parameter_other_is_null()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_ValidationFailure___Should_return_true___When_parameter_other_is_same_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_ValidationFailure___Should_return_false___When_parameter_other_is_derived_from_the_same_type_but_is_not_of_the_same_type_as_this_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_ValidationFailure___Should_return_false___When_objects_being_compared_have_different_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_ValidationFailure___Should_return_true___When_objects_being_compared_have_same_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
