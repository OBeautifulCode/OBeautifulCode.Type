...
namespace OBeautifulCode.Type.Test
{
    ...
    {
        private static readonly StringRepresentationTestScenarios<SelfValidationFailure> StringRepresentationTestScenarios = new StringRepresentationTestScenarios<SelfValidationFailure>();

        private static readonly ConstructorArgumentValidationTestScenarios<SelfValidationFailure> ConstructorArgumentValidationTestScenarios = new ConstructorArgumentValidationTestScenarios<SelfValidationFailure>()
            .AddScenario(() =>
                new ConstructorArgumentValidationTestScenario<SelfValidationFailure>
                {
                    Name = "constructor should throw ArgumentNullException when parameter 'propertyNames' is null scenario",
                    ConstructionFunc = () =>
                    {
                        var referenceObject = A.Dummy<SelfValidationFailure>();
                    ...
                    ExpectedExceptionMessageContains = new[] { "propertyNames", },
                })
            .AddScenario(() =>
                new ConstructorArgumentValidationTestScenario<SelfValidationFailure>
                {
                    Name = "constructor should throw ArgumentException when parameter 'propertyNames' is an empty enumerable scenario",
                    ConstructionFunc = () =>
                    {
                        var referenceObject = A.Dummy<SelfValidationFailure>();
                    ...
                    ExpectedExceptionMessageContains = new[] { "propertyNames", "is an empty enumerable", },
                })
            .AddScenario(() =>
                new ConstructorArgumentValidationTestScenario<SelfValidationFailure>
                {
                    Name = "constructor should throw ArgumentException when parameter 'propertyNames' contains a null element scenario",
                    ConstructionFunc = () =>
                    {
                        var referenceObject = A.Dummy<SelfValidationFailure>();

                        var result = new SelfValidationFailure(
                                             new string[0].Concat(referenceObject.PropertyNames).Concat(new string[] { null }).Concat(referenceObject.PropertyNames).ToList(),
                                             referenceObject.Message);

                        return result;
                    },
                    ExpectedExceptionType = typeof(ArgumentException),
                    ExpectedExceptionMessageContains = new[] { "propertyNames", "contains at least one null element", },
                })
            .AddScenario(() =>
                new ConstructorArgumentValidationTestScenario<SelfValidationFailure>
                {
                    Name = "constructor should throw ArgumentException when parameter 'propertyNames' contains a white space element scenario",
                    ConstructionFunc = () =>
                    {
                        var referenceObject = A.Dummy<SelfValidationFailure>();

                        var result = new SelfValidationFailure(
                                             new string[0].Concat(referenceObject.PropertyNames).Concat(new string[] { "  \r\n  " }).Concat(referenceObject.PropertyNames).ToList(),
                                             referenceObject.Message);

                        return result;
                    },
                    ExpectedExceptionType = typeof(ArgumentException),
                    ExpectedExceptionMessageContains = new[] { "propertyNames", "contains an element that is white space", },
                })
            .AddScenario(() =>
                new ConstructorArgumentValidationTestScenario<SelfValidationFailure>
                {
        ...
        private static readonly ConstructorPropertyAssignmentTestScenarios<SelfValidationFailure> ConstructorPropertyAssignmentTestScenarios = new ConstructorPropertyAssignmentTestScenarios<SelfValidationFailure>()
            .AddScenario(() =>
                new ConstructorPropertyAssignmentTestScenario<SelfValidationFailure>
                {
                    Name = "PropertyNames should return same 'propertyNames' parameter passed to constructor when getting",
                    SystemUnderTestExpectedPropertyValueFunc = () =>
                    {
                        var referenceObject = A.Dummy<SelfValidationFailure>();

                        var result = new SystemUnderTestExpectedPropertyValue<SelfValidationFailure>
                        {
                            SystemUnderTest = new SelfValidationFailure(
                                                      referenceObject.PropertyNames,
                                                      referenceObject.Message),
                            ExpectedPropertyValue = referenceObject.PropertyNames,
                        };
        ...
        private static readonly DeepCloneWithTestScenarios<SelfValidationFailure> DeepCloneWithTestScenarios = new DeepCloneWithTestScenarios<SelfValidationFailure>()
            .AddScenario(() =>
                new DeepCloneWithTestScenario<SelfValidationFailure>
                {
                    Name = "DeepCloneWithPropertyNames should deep clone object and replace PropertyNames with the provided propertyNames",
                    WithPropertyName = "PropertyNames",
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        var systemUnderTest = A.Dummy<SelfValidationFailure>();

                        var referenceObject = A.Dummy<SelfValidationFailure>().ThatIs(_ => !systemUnderTest.PropertyNames.IsEqualTo(_.PropertyNames));

                        var result = new SystemUnderTestDeepCloneWithValue<SelfValidationFailure>
                        {
                            SystemUnderTest = systemUnderTest,
                            DeepCloneWithValue = referenceObject.PropertyNames,
                        };
            ...
            .AddScenario(() =>
                new DeepCloneWithTestScenario<SelfValidationFailure>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<SelfValidationFailure>().ThatIs(_ => !systemUnderTest.Message.IsEqualTo(_.Message));
        ...
        private static readonly EquatableTestScenarios<SelfValidationFailure> EquatableTestScenarios = new EquatableTestScenarios<SelfValidationFailure>()
            .AddScenario(() =>
                new EquatableTestScenario<SelfValidationFailure>
                {
                    ...
                    ObjectsThatAreEqualToButNotTheSameAsReferenceObject = new SelfValidationFailure[]
                    {
                    ...
                    ObjectsThatAreNotEqualToReferenceObject = new SelfValidationFailure[]
                    {
                        new SelfValidationFailure(
        ...
        public static class Structural
        {
            ...
            public static void SelfValidationFailure___Should_declare_ToString_method___When_reflecting()
            {
                // Arrange
                var expected = typeof(SelfValidationFailure);
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void SelfValidationFailure___Should_be_attributed_with_Serializable____When_reflecting()
            {
                // Arrange
                var type = typeof(SelfValidationFailure);
        ...
        public static class Cloning
        {
            ...
            public static void Clone___Should_clone_object___When_called()
            {
                ...
                // Act
                var actual = (SelfValidationFailure)systemUnderTest.Clone();
            ...
            public static void DeepClone___Should_deep_clone_object___When_called()
            {
                ...
                if (systemUnderTest.PropertyNames == null)
                {
                    actual.PropertyNames.AsTest().Must().BeNull();
                }
                else if (!actual.PropertyNames.GetType().IsValueType)
                {
                    // When the declared type is a reference type, we still have to check the runtime type.
                    // The object could be a boxed value type, which will fail this asseration because
                    // a deep clone of a value type object is the same object.
                    actual.PropertyNames.AsTest().Must().NotBeSameReferenceAs(systemUnderTest.PropertyNames);
                }
            }
            ...
            {
                var propertyNames = new string[] { "PropertyNames", "Message" };
                ...
                foreach (var scenario in scenarios)
                {
                    ...
                    // Act
                    var actual = (SelfValidationFailure)scenario.DeepCloneWithMethod.Invoke(scenario.SystemUnderTest, new[] { scenario.WithValue });

                    // Assert
                    foreach (var propertyName in propertyNames)
                    {
                        var propertyInfo = typeof(SelfValidationFailure).GetPropertyFiltered(propertyName, MemberRelationships.DeclaredOrInherited, MemberOwners.Instance, MemberAccessModifiers.Public);
