...
namespace OBeautifulCode.Type.Test
{
    ...
    public static partial class GetConstValueOpTValueTest
    {
                ...
                new StringRepresentationTestScenario<GetConstValueOp<Version>>
                {
                    ...
                    SystemUnderTestExpectedStringRepresentationFunc = () =>
                    {
                        ...
                        var result = new SystemUnderTestExpectedStringRepresentation<GetConstValueOp<Version>>
                        {
                            ...
                            ExpectedStringRepresentation = Invariant($"OBeautifulCode.Type.GetConstValueOp<Version>: Value = {systemUnderTest.Value?.ToString() ?? "<null>"}."),
                        };
        ...
        private static readonly ConstructorArgumentValidationTestScenarios<GetConstValueOp<Version>> ConstructorArgumentValidationTestScenarios = new ConstructorArgumentValidationTestScenarios<GetConstValueOp<Version>>()
            .AddScenario(() =>
                new ConstructorArgumentValidationTestScenario<GetConstValueOp<Version>>
                {
                    Name = "constructor should throw ArgumentNullException when parameter 'value' is null scenario",
                    ConstructionFunc = () =>
                    {
                        var result = new GetConstValueOp<Version>(
                                             null);
        ...
        private static readonly ConstructorPropertyAssignmentTestScenarios<GetConstValueOp<Version>> ConstructorPropertyAssignmentTestScenarios = new ConstructorPropertyAssignmentTestScenarios<GetConstValueOp<Version>>()
            .AddScenario(() =>
                new ConstructorPropertyAssignmentTestScenario<GetConstValueOp<Version>>
                {
                    Name = "Value should return same 'value' parameter passed to constructor when getting",
                    SystemUnderTestExpectedPropertyValueFunc = () =>
                    {
                        var referenceObject = A.Dummy<GetConstValueOp<Version>>();

                        var result = new SystemUnderTestExpectedPropertyValue<GetConstValueOp<Version>>
                        {
                            SystemUnderTest = new GetConstValueOp<Version>(
        ...
        private static readonly EquatableTestScenarios<GetConstValueOp<Version>> EquatableTestScenarios = new EquatableTestScenarios<GetConstValueOp<Version>>()
            .AddScenario(() =>
                new EquatableTestScenario<GetConstValueOp<Version>>
                {
                    ...
                    {
                        new GetConstValueOp<Version>(
                                A.Dummy<GetConstValueOp<Version>>().Whose(_ => !_.Value.IsEqualTo(ReferenceObjectForEquatableTestScenarios.Value)).Value),
                    },
