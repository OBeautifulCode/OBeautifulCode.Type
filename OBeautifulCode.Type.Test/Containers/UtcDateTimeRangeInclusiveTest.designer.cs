// --------------------------------------------------------------------------------------------------------------------
// <auto-generated>
//   Generated using OBeautifulCode.CodeGen.ModelObject (1.0.52.0)
// </auto-generated>
// --------------------------------------------------------------------------------------------------------------------
...
namespace OBeautifulCode.Type.Test
{
    ...
    {
        private static readonly StringRepresentationTestScenarios<UtcDateTimeRangeInclusive> StringRepresentationTestScenarios = new StringRepresentationTestScenarios<UtcDateTimeRangeInclusive>();

        private static readonly ConstructorArgumentValidationTestScenarios<UtcDateTimeRangeInclusive> ConstructorArgumentValidationTestScenarios = new ConstructorArgumentValidationTestScenarios<UtcDateTimeRangeInclusive>();

        private static readonly ConstructorPropertyAssignmentTestScenarios<UtcDateTimeRangeInclusive> ConstructorPropertyAssignmentTestScenarios = new ConstructorPropertyAssignmentTestScenarios<UtcDateTimeRangeInclusive>()
            .AddScenario(() =>
                new ConstructorPropertyAssignmentTestScenario<UtcDateTimeRangeInclusive>
                {
                    Name = "StartDateTimeInUtc should return same 'startDateTimeInUtc' parameter passed to constructor when getting",
                    SystemUnderTestExpectedPropertyValueFunc = () =>
                    {
                        var referenceObject = A.Dummy<UtcDateTimeRangeInclusive>();

                        var result = new SystemUnderTestExpectedPropertyValue<UtcDateTimeRangeInclusive>
                        {
                            SystemUnderTest = new UtcDateTimeRangeInclusive(
                                                      referenceObject.StartDateTimeInUtc,
                                                      referenceObject.EndDateTimeInUtc),
                            ExpectedPropertyValue = referenceObject.StartDateTimeInUtc,
                        };

                        return result;
                    },
                    PropertyName = "StartDateTimeInUtc",
                })
            .AddScenario(() =>
                new ConstructorPropertyAssignmentTestScenario<UtcDateTimeRangeInclusive>
                {
                    Name = "EndDateTimeInUtc should return same 'endDateTimeInUtc' parameter passed to constructor when getting",
                    SystemUnderTestExpectedPropertyValueFunc = () =>
                    {
                        var referenceObject = A.Dummy<UtcDateTimeRangeInclusive>();
                        ...
                        var result = new SystemUnderTestExpectedPropertyValue<UtcDateTimeRangeInclusive>
                        {
                            SystemUnderTest = new UtcDateTimeRangeInclusive(
                                                      referenceObject.StartDateTimeInUtc,
                                                      referenceObject.EndDateTimeInUtc),
                            ExpectedPropertyValue = referenceObject.EndDateTimeInUtc,
                        };

                        return result;
                    },
                    PropertyName = "EndDateTimeInUtc",
                });

        private static readonly DeepCloneWithTestScenarios<UtcDateTimeRangeInclusive> DeepCloneWithTestScenarios = new DeepCloneWithTestScenarios<UtcDateTimeRangeInclusive>()
            .AddScenario(() =>
                new DeepCloneWithTestScenario<UtcDateTimeRangeInclusive>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<UtcDateTimeRangeInclusive>().ThatIs(_ => !systemUnderTest.StartDateTimeInUtc.IsEqualTo(_.StartDateTimeInUtc));
            ...
            .AddScenario(() =>
                new DeepCloneWithTestScenario<UtcDateTimeRangeInclusive>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<UtcDateTimeRangeInclusive>().ThatIs(_ => !systemUnderTest.EndDateTimeInUtc.IsEqualTo(_.EndDateTimeInUtc));
        ...
        public static class Structural
        {
            ...
            public static void UtcDateTimeRangeInclusive___Should_implement_IModel_of_UtcDateTimeRangeInclusive___When_reflecting()
            {
                ...
                // Act
                var expected = typeof(IModel<UtcDateTimeRangeInclusive>).IsAssignableFrom(type);
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void UtcDateTimeRangeInclusive___Should_be_attributed_with_Serializable____When_reflecting()
            {
                // Arrange
                var type = typeof(UtcDateTimeRangeInclusive);
        ...
        public static class Cloning
        {
            ...
            {
                var propertyNames = new string[] { "StartDateTimeInUtc", "EndDateTimeInUtc" };
                ...
                foreach (var scenario in scenarios)
                {
                    ...
                    // Act
                    var actual = (UtcDateTimeRangeInclusive)scenario.DeepCloneWithMethod.Invoke(scenario.SystemUnderTest, new[] { scenario.WithValue });

                    // Assert
                    foreach (var propertyName in propertyNames)
                    {
                        var property = typeof(UtcDateTimeRangeInclusive).GetProperty(propertyName);
